"""
Django settings for rapid_union_dev_116083 project.
...
ROOT_URLCONF = 'rapid_union_dev_116083.urls'
...
WSGI_APPLICATION = 'rapid_union_dev_116083.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rapid_union_dev_116083 API",
    "DESCRIPTION": "API documentation for rapid_union_dev_116083 App",
    "VERSION": "v1",
}
